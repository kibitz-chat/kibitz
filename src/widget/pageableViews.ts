...
export const VIEW_LABEL: Record<CallView, string> = { speaker: 'Speaker', gallery: 'Gallery', car: 'Car', strip: 'Strip' }
export const VIEW_ICON: Record<CallView, string> = { speaker: '▭', gallery: '▦', car: '🚗', strip: '▥' }
