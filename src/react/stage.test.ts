...
const p = (id: string, meta: Record<string, unknown>, shareStream: MediaStream | null = S) => ({ id, meta, shareStream })
...
describe('pickPresenter — newest presenter with a SHARE stream wins the stage', () => {
